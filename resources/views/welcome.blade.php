...
<body>
    ...
    <div class="grid grid-cols-4">
        <div class="border p-8 m-5 rounded-xl hover:border-violet-900 border-blue-500">
            <a href=""
                class="text-xl font-sans text-purple-600 shadow-2xl hover:transition-all hover:shadow-red-500">powerful
                features and integration<i class="fad fa-plus fa-spin"></i></a>
        </div>
        <div class="border p-8 m-5 rounded-xl hover:border-violet-900 border-blue-500">
    ...
    <marquee behavior="" direction="" class="p-5 text-4xl text-sky-700">The Proton Family plan lets you protect
        your loved ones by giving them access to all Proton services and premium features.</marquee>
    <div class="h-screen bg-violet-950">
        <div class="text-center container">
            ...
            <button
                class="p-2 rounded-2xl transition-transform bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 text-yellow-50">create
                account &nbsp;<span class=" hover:block text-yellow-50"><i
                        class="fa-solid fa-arrow-right fa-beat"></i></span></button>
        </div>
    </div>
</body>
